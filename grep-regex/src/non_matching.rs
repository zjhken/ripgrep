use grep_matcher::NonMatchingBytes;
use regex_syntax::hir::{self, Hir, HirKind};
use utf8_ranges::Utf8Sequences;

/// Return a confirmed set of non-matching bytes from the given expression.
pub fn non_matching_bytes(expr: &Hir) -> NonMatchingBytes {
    let mut set = NonMatchingBytes::full();
...
mod tests {
    ...
    fn extract(pattern: &str) -> NonMatchingBytes {
    ...
    fn sparse(set: &NonMatchingBytes) -> Vec<u8> {
